 ...
 **• 동작 조건:** <br>  
   ...
   **조건 B (첫 질문인 경우):** 재작성 없이 즉시 ⁠route⁠ → ⁠retrieve⁠를 먼저 시도합니다. 이후 1차 검색 결과의 랭킹 1위(top) 리랭커 점수가 0.6 미만일 때만 ⁠rewrite⁠ → ⁠retrieve⁠ 경로로 재시도합니다. (1회 한정으로 동작하여 무한 루프를 방지하며, 재시도 후에도 점수가 낮으면 그대로 ⁠answer⁠ 노드로 진입합니다.)<br>  
