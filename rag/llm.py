# -*- coding: utf-8 -*-
"""모델 추상화: 노드별 모델을 쉽게 교체. OpenAI(기본) / Ollama(--local).

키 우선순위: 명시 인자(UI 입력) > 환경변수 OPENAI_API_KEY > .env(개발용).
...
class LLM:
    """단일 인터페이스. provider='openai'|'ollama'. api_key는 메모리에만."""
